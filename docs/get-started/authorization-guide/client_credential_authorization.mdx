...
- Downloaded the <a href="/files/mcp-express-cli.js" download>MCP CLI</a>
...
4. After creation, your **Client ID** and **Client Secret** will be displayed. Copy them for use in the AI tool configuration.
   ...
   ![](/resources/get-started/authorization-guide/client_credentials_screen.png)
...
:::info
Need more details on setup, commands, and MCP behavior in Claude Desktop? [View Claude Desktop docs](https://platform.claude.com/docs/en/agent-sdk/mcp#from-a-config-file)
:::
...
:::info
Need help with Cursor MCP setup or understanding how Cursor manages context? [View Cursor MCP docs](https://cursor.com/docs/mcp)
:::
...
:::info
Need more details on VS Code MCP setup and usage? [View VS Code MCP docs](https://code.visualstudio.com/docs/copilot/customization/mcp-servers#_add-an-mcp-server)
:::
...
:::info
Need more details on Windsurf MCP setup and usage? [View Windsurf MCP docs](https://docs.windsurf.com/windsurf/cascade/mcp)
:::
...
:::info
Need more details on Codex MCP setup and usage? [View Codex MCP docs](https://developers.openai.com/codex/mcp)
:::
