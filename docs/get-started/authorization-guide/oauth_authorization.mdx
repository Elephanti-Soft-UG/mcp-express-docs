---
title: MCP Express OAuth Guide
sidebar_position: 1
sidebar_label: 'Oauth Authorization'
---

# MCP Express OAuth Guide
...
:::info
Learn how Cursor integrates with MCP servers and manages context. [View Cursor MCP docs](https://docs.cursor.com/context/model-context-protocol)
:::
...
:::info
Read more about configuring connectors and using MCP servers in Claude Desktop. [View Claude Desktop docs](https://support.anthropic.com/en/articles/10168395-setting-up-mcp-servers-in-claude-for-desktop)
:::
...
:::info
Understand how MCP configuration works in Windsurf and how to extend it. [View Windsurf MCP docs](https://docs.windsurf.com/windsurf/mcp)
:::
...
![MCP Express Authorization Screen](/resources/get-started/authorization-guide/mcp_express_authorization_screen.png)
