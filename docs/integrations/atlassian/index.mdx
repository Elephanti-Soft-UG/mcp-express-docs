...
![Confluence Authentication](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/atlassian/confluence-auth.png)
...
- Search for pages containing the word "API":
  ...
  ![Confluence Search Config](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/atlassian/confluence-search-config.png)
...
- Read the content of page with ID `12345`:
  ...
  ![Confluence Read Config](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/atlassian/confluence-read-config.png)
...
- Create or update a page titled "New API Documentation":
  ...
  ![Confluence Read Config](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/atlassian/confluence-write-config.png)
...
![Confluence Search Config](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/atlassian/confluence-dynamic-search-config-1.png)
...
![Confluence Search Config](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/atlassian/confluence-dynamic-search-config-2.png)
...
![Confluence Read Config](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/atlassian/confluence-dynamic-read-config.png)
...
![Confluence Write Config](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/atlassian/confluence-dynamic-write-config.png)
