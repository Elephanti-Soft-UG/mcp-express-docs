...
<Tabs>
  <TabItem value='quick-connect' label='Quick Connect' default>
    **Quick Connect** simplifies the setup process by automatically populating all
    ...
    ![Quick Connect Auto Fill Details Via Connection String](/resources/integrations/postgresql/quick_connect_connection_string.gif)
  </TabItem>
  <TabItem value='manual-configuration' label='Manual Configuration'>
    **Manual configuration** requires you to enter the following database connection details:
    ...
    ![Dangerous Keywords Configuration](/resources/integrations/postgresql/advanced_settings_of_dangerous_keywords_in_postgres.png)
