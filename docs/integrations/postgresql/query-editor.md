...
![Claude Answering Queries By Checking Postgres Database](../../images/create_sql_query_by_selecting_tables_and_columns.gif)
...
![Custom SQL Method](../../images/custom-sql-query-for-query-editor-page.png)
...
![Claude Answering Queries By Checking Postgres Database](../../images/sql_for_ai_to_generate_query.png)
...
In the final step, provide a title and description for your tool. The AI assistant uses this information to determine when to invoke the tool during interactions.

> [!TIP]
> To allow access to your PostgreSQL database to your AI assistants, follow these links:
> - [Connect with AI](https://www.mcp-express.com/blogs/create-and-connect-mcp-server-with-claude-under-5-minutes)
> - [How to Query Your Database Using Natural Language?](https://www.mcp-express.com/blogs/how-to-query-your-database-using-natural-language-in-5-minutes)