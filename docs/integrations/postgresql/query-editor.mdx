...
<Tabs>
  <TabItem value='create-sql' label='Create SQL' default>
    ...
    ![Claude Answering Queries By Checking Postgres Database](/resources/integrations/postgresql/create_sql_query_by_selecting_tables_and_columns.gif)
  ...
  <TabItem value='custom-sql' label='Custom SQL'>
   Custom SQL lets you write your own queries for advanced and complex use cases.
    ...
    ![Custom SQL Method](/resources/integrations/postgresql/custom-sql-query-for-query-editor-page.png)
    ...
    ![Claude Answering Queries By Checking Postgres Database](/resources/integrations/postgresql/sql_for_ai_to_generate_query.png)
