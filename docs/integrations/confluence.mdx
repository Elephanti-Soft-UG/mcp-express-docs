...
![Confluence Authentication](/resources/integrations/confluence/confluence-auth.png)
...
- Search for pages containing the word "API":
  ...
  ![Confluence Search Config](/resources/integrations/confluence/confluence-search-config.png)
...
- Read the content of page with ID `12345`:
  ...
  ![Confluence Read Config](/resources/integrations/confluence/confluence-read-config.png)
...
- Create or update a page titled "New API Documentation":
  ...
  ![Confluence Read Config](/resources/integrations/confluence/confluence-write-config.png)
...
![Confluence Search Config](/resources/integrations/confluence/confluence-dynamic-search-config-1.png)
...
![Confluence Search Config](/resources/integrations/confluence/confluence-dynamic-search-config-2.png)
...
![Confluence Read Config](/resources/integrations/confluence/confluence-dynamic-read-config.png)
...
![Confluence Write Config](/resources/integrations/confluence/confluence-dynamic-write-config.png)
