...
The tool accepts Remote Path, Remote File Path, Local Path, and File Content. Treat any user-provided value as untrusted until your tool configuration validates it.
