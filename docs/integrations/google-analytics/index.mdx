...
2. In the top navigation bar, click the project selector dropdown.
   ![Google Cloud save/select project flow](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_cloud_console_save_project_section.webp)
3. Click **New Project** if needed, or select an existing project.
   ![Google Cloud project selector and create project flow](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_cloud_console_new_project_section.webp)
...
2. Go to **APIs & Services -> Library**.
   ...
   ![APIs and Services section in Google Cloud Console](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_cloud_console_api_and_services_tab.webp)

3. Search for **Google Analytics Data API**.
   ![Search for Google Analytics Data API](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_cloud_console_search_bar.webp)
4. Open it and click **Enable**.
   ![Google Analytics Data API result page](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_analytics_data_api_section.webp)
...
2. Go to **IAM & Admin -> Service Accounts**.
   ![IAM and Service Accounts in Google Cloud Console](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_cloud_sonsole_iam_section.webp)
3. Click **Create Service Account**.
   ![Create a new service account](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_cloud_console_create_service_account.webp)
...
2. Go to the **Keys** tab.
   ![Service account keys tab](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_cloud_console_service_account_keys.webp)
3. Click **Add Key -> Create new key**. 4. Choose **JSON** and click **Create**. 5. Save the downloaded file securely.
   ![Create a new JSON key](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/google_cloud_console_create_new_key.webp)
...
2. Click **Admin** (bottom-left).
   ![GA4 property access management](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/ga4-property-access-management.webp)
3. Go to **Property Access Management**.
4. Click **+ -> Add users**.
   ![GA4 add user dialog](https://mcp-express-connectors-registry.s3.eu-central-1.amazonaws.com/integrations/images/google-analytics/ga4-add-user.webp)
