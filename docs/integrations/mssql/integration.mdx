...
To interface your MCP server with a MS SQL Server instance, you must define the connection parameters and establish a secure handshake. This process ensures the server can successfully orchestrate query execution and schema inference.
...
![Manual Connect MS SQL Server Method](/resources/integrations/mssql/manual_connection_required_detail_for_postgresql.png)
...
If you have a MS SQL Server Connection URI (e.g., mssql://user:pass@host:1433/db), use the Quick Connect toggle. This automatically parses and populates all required fields in a single step.
:::
