...
This section outlines the guardrails and usage patterns that are specific to the SFTP connector. The main risks here are broad path scope, overly permissive wildcard matching, oversized directory scans, and unsafe use of templated paths or content.
